...
sub onItemSelected()
    ...
    if selectedIndex >= list.content.getChildCount() then
        return
    end if
...
'//# sourceMappingURL=./OptionsSlider.brs.map