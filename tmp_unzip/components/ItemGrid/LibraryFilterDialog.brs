...
sub init()
    ...
    m.submitButton.focusBackground = chainLookupReturn(m.global.session, "user.settings.colorCursor", "#7B2FBE")
    ...
    m.filterOptionsMenu.focusBitmapBlendColor = chainLookupReturn(m.global.session, "user.settings.colorCursor", "#7B2FBE")
    m.filterOptionsMenu.focusFootprintBlendColor = "#7B2FBE88"
