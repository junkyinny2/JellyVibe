...
sub init()
    ...
    mySubtitleBackground.color = "#020B2A"
    m.languageButton.textColor = "#101010"
    m.languageButton.focusTextColor = "#ffffff"
    m.languageButton.background = "#ffffff"
    m.languageButton.focusBackground = chainLookupReturn(m.global.session, "user.settings.colorCursor", "#7B2FBE")
    m.searchButton.background = "#c8fafa"
    m.searchButton.color = "#101010"
    m.searchButton.focusBackground = chainLookupReturn(m.global.session, "user.settings.colorCursor", "#7B2FBE")
    m.searchButton.focusColor = "#ffffff"
    m.mySubtitleList.focusBitmapBlendColor = chainLookupReturn(m.global.session, "user.settings.colorCursor", "#7B2FBE")
