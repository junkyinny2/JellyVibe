...
sub init()
    ...
    m.screenSettings.focusedColor = chainLookupReturn(m.global.session, "user.settings.colorCursor", "#7B2FBE")
    m.screenSettings.focusBitmapBlendColor = chainLookupReturn(m.global.session, "user.settings.colorCursor", "#7B2FBE")
