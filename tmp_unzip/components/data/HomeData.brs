...
sub setData()
    ...
    if LCase(datum.type) = "collectionfolder" or LCase(datum.type) = "userview"
        ...
        else if isStringEqual(m.top.CollectionType, "mylist")
            m.top.iconUrl = "pkg:/images/icons/star.png"
        else if LCase(m.top.CollectionType) = "movies"
            m.top.iconUrl = "pkg:/images/media_type_icons/movie.png"
        else if LCase(m.top.CollectionType) = "tvshows"
            m.top.iconUrl = "pkg:/images/media_type_icons/tv.png"
        else if LCase(m.top.CollectionType) = "music"
            m.top.iconUrl = "pkg:/images/media_type_icons/music_white.png"
        else if LCase(m.top.CollectionType) = "playlists" or LCase(m.top.CollectionType) = "boxsets" or LCase(m.top.CollectionType) = "boxset" or LCase(m.top.CollectionType) = "collections"
            m.top.iconUrl = "pkg:/images/media_type_icons/folder_white.png"
        end if
...
'//# sourceMappingURL=./HomeData.brs.map